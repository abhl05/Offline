...
echo ========================================
echo Compiling 2305007_Problem1.cpp...
echo ========================================
g++ -o 2305007_Problem1.exe 2305007_Problem1.cpp
if errorlevel 1 (
...
for %%i in (1 2 3 4 5) do (
    ...
    2305007_Problem1.exe < "Test_Cases\Test_Cases\Problem 1\Inputs\%%i.txt" > temp_output.txt
    ...
    set "expected_line="
    for /f "usebackq delims=" %%b in ("Test_Cases\Test_Cases\Problem 1\Outputs\%%i.txt") do (
